...
public class TomdroidGuiTest extends ActivityInstrumentationTestCase2 {
	...
	public void testTrace00000 () {
		...
		// Testing transition 
		// Firing event: e13
		fireEvent (0, "", "listView", "longClickListItem", "4");
		...
		// Testing transition 
		// Firing event: e20
		fireEvent (16908313, 18, "Yes", "button", "click");
		...
		// Testing transition 
		// Firing event: e33
		fireEvent (0, "", "listView", "longClickListItem", "1");
		...
		// Testing transition 
		// Firing event: e42
		fireEvent (16908327, 5, "", "linearLayout", "click");
		...
		// Testing transition 
		// Firing event: e85
		fireEvent (0, "", "listView", "longClickListItem", "5");
		...
		// Testing transition 
		// Firing event: e110
		fireEvent (16908298, 17, "", "preferenceList", "selectListItem", "22");
		...
		// Testing transition 
		// Firing event: e115
		fireEvent (16908298, 19, "", "preferenceList", "selectListItem", "2");
		...
		// Firing event: e144
		fireEvent (16908314, 19, "Cancel", "button", "click");
		...
		// Testing transition 
		// Firing event: e155
		fireEvent (16908298, 17, "", "preferenceList", "selectListItem", "7");
		...
		// Testing transition 
		// Firing event: e177
		fireEvent (10, "", "singleChoiceList", "longClickListItem", "2");
		...
		// Testing transition 
		// Firing event: e186
		fireEvent (16908298, 17, "", "preferenceList", "selectListItem", "5");
		...
		// Testing transition 
		// Firing event: e218
		fireEvent (16908298, 17, "", "preferenceList", "selectListItem", "4");
		...
		// Testing transition 
		// Firing event: e253
		fireEvent (16908298, 17, "", "preferenceList", "selectListItem", "14");
		...
		// Testing transition 
		// Firing event: e273
		fireEvent (16908298, 17, "", "preferenceList", "selectListItem", "9");
