...
/* WordPress 2.1 Original Version Random - WP2.1_2 */
...
public class AndroidGuiTest extends ActivityInstrumentationTestCase2 {
	...
	public void testTrace00001 () {
		...
		// Testing transition 
		// Firing event: e104
		fireEvent (2131165254, 24, "", "linearLayout", "click");
		...
		// Testing transition 
		// Firing event: e443
		fireEvent (2131165201, 48, "", "button", "click");
		...
		// Testing transition 
		// Firing event: e493
		fireEvent (2131165200, 46, "", "button", "click");
		...
		// Testing transition 
		// Firing event: e535
		fireEvent (2131165413, 38, "", "button", "click");
