...
int main(int argc, char** argv) {
	...
	string outPath = fullPath.substr(0, fullPath.find(".")) + "_p3.java";
	...
	infile.close();
	outfile.close();
	cout << "Finished parsing JUnit file." << endl;
	return 0;
}
 ...
 * @param string inputText
 * @return new string containing the class changed to match new file name
 */
string classNameFix(string inputText) {
