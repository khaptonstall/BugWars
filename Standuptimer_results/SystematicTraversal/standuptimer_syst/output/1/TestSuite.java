...
public class StanduptimerGuiTest extends ActivityInstrumentationTestCase2 {
	...
	public final static String PACKAGE_NAME = "net.johnpwood.android.standuptimer";
	public final static String CLASS_NAME = "net.johnpwood.android.standuptimer.ConfigureStandupTimer";
	...
	// Generated from trace 109
	public void testTrace00000 () {

		// Testing base activity
		retrieveWidgets();
		// Testing current activity: should be a1
		solo.assertCurrentActivity("Testing base activity", "ConfigureStandupTimer");
		...
		solo.assertCurrentActivity("", "ConfigureStandupTimer");
		...
		// Testing transition 
		// Firing event: e19
		fireEvent (4, "Help", "menuItem", "click");

		retrieveWidgets();
		// Testing current activity: should be a5
		solo.assertCurrentActivity("", "Help");
		...
		// Testing transition 
		// Firing event: e40
		fireEvent (2, "Teams", "menuItem", "click");

		retrieveWidgets();
		// Testing current activity: should be a9
		solo.assertCurrentActivity("", "TeamList");
		...
		// Testing transition 
		// Firing event: e63
		fireEvent (1, "Add", "menuItem", "click");
		...
		// Testing transition 
		// Setting input: i12
		setInput (2131361795, "writeText", "18");
		// Firing event: e82
		fireEvent (16908313, 16, "OK", "button", "click");
		...
		// Testing transition 
		// Setting input: i14
		setInput (2131361798, "writeText", "21");
		// Firing event: e92
		fireEvent (2131361800, 20, "", "spinner", "selectSpinnerItem", "1");
		...
		setInput (2131361798, "writeText", "21");
		// Firing event: e106
		fireEvent (2131361801, 23, "Start", "button", "click");
		...
		// Testing transition 
		// Firing event: e118
		fireEvent (16908315, 17, "OK", "button", "click");
