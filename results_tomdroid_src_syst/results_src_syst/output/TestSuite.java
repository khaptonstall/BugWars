...
public class TomdroidGuiTest extends ActivityInstrumentationTestCase2 {
	...
	public void testTrace00001 () {
		...
		// Testing transition 
		// Firing event: e1
		fireEvent (2131296259, 5, "", "image", "click");
	...
	public void testTrace00003 () {
		...
		// Testing transition 
		// Firing event: e2
		fireEvent (16908298, 8, "", "listView", "selectListItem", "1");

		retrieveWidgets();
		// Testing current activity: should be a4
		solo.assertCurrentActivity("", "ViewNote");
	...
	public void testTrace00008 () {
		...
		// Testing transition 
		// Firing event: e3
		fireEvent (16908298, 8, "", "listView", "longClickListItem", "1");

		retrieveWidgets();
		// Testing current activity: should be a5
		solo.assertCurrentActivity("", "Tomdroid");
		doTestWidget("com.android.internal.widget.DialogTitle", "Note Options");
		doTestWidget("com.android.internal.app.AlertController$RecycleListView", "");
	...
	public void testTrace00015 () {
		...
		solo.assertCurrentActivity("", "Tomdroid");
		doTestWidget("com.android.internal.view.menu.IconMenuView", "");
	...
	public void testTrace00018 () {
		...
		// Testing transition 
		// Firing event: e25
		fireEvent (1, "Send", "menuItem", "click");

		// This event leads to Tomdroid
		solo.sleep (SLEEP_AFTER_TASK);
	}

	// Generated from trace 26
	...
	public void testTrace00022 () {
		...
		// Testing transition 
		// Firing event: e19
		fireEvent (1, "Search", "menuItem", "click");

		retrieveWidgets();
		// Testing current activity: should be a21
		solo.assertCurrentActivity("", "Tomdroid");
		doTestWidget(16908820, "android.widget.Button", "");
	...
	public void testTrace00025 () {
		...
		// Testing transition 
		// Firing event: e20
		fireEvent (2, "About", "menuItem", "click");

		retrieveWidgets();
		// Testing current activity: should be a22
		solo.assertCurrentActivity("", "Tomdroid");
		doTestWidget("com.android.internal.widget.DialogTitle", "About Tomdroid");
		doTestWidget(16908313, "android.widget.Button", "OK");
		doTestWidget(16908314, "android.widget.Button", "Project page");
	...
	public void testTrace00026 () {
		...
		// Testing transition 
		// Firing event: e33
		fireEvent (16908314, 17, "Project page", "button", "click");

		// This event leads to Tomdroid
		solo.sleep (SLEEP_AFTER_TASK);
	}

	// Generated from trace 34
	...
	public void testTrace00030 () {
		...
		// Testing transition 
		// Firing event: e21
		fireEvent (3, "Settings", "menuItem", "click");

		retrieveWidgets();
		// Testing current activity: should be a23
		solo.assertCurrentActivity("", "PreferencesActivity");

		// Testing transition 
		// Firing event: e38
		fireEvent (16908298, 1, "", "preferenceList", "selectListItem", "2");

		retrieveWidgets();
		// Testing current activity: should be a39
		solo.assertCurrentActivity("", "PreferencesActivity");
		doTestWidget("com.android.internal.widget.DialogTitle", "Choose the sync service to use");
		doTestWidget("com.android.internal.app.AlertController$RecycleListView", "");
		doTestWidget(16908314, "android.widget.Button", "Cancel");

		solo.sleep (SLEEP_AFTER_TASK);
	}

	// Generated from trace 40
	public void testTrace00031 () {
		...
		// Testing transition 
		// Firing event: e40
		fireEvent (16908298, 1, "", "preferenceList", "selectListItem", "4");
	...
	public void testTrace00032 () {
		...
		// Testing transition 
		// Firing event: e41
		fireEvent (16908298, 1, "", "preferenceList", "selectListItem", "5");
	...
	public void testTrace00036 () {
		...
		// Testing transition 
		// Firing event: e37
		fireEvent (16908298, 1, "", "preferenceList", "selectListItem", "1");
		...
		// Testing transition 
		// Firing event: e45
		fireEvent (8, "", "singleChoiceList", "selectListItem", "1");
	...
	public void testTrace00037 () {
		...
		// Testing transition 
		// Firing event: e46
		fireEvent (8, "", "singleChoiceList", "selectListItem", "2");
	...
	public void testTrace00038 () {
		...
		// Testing transition 
		// Firing event: e47
		fireEvent (8, "", "singleChoiceList", "longClickListItem", "1");
	...
	public void testTrace00039 () {
		...
		// Testing transition 
		// Firing event: e48
		fireEvent (8, "", "singleChoiceList", "longClickListItem", "2");
	...
	public void testTrace00040 () {
		...
		// Testing transition 
		// Firing event: e49
		fireEvent (16908314, 18, "Cancel", "button", "click");
	...
	public void testTrace00044 () {
		...
		// Testing transition 
		// Firing event: e39
		fireEvent (16908298, 1, "", "preferenceList", "selectListItem", "3");

		retrieveWidgets();
		// Testing current activity: should be a41
		solo.assertCurrentActivity("", "PreferencesActivity");
		doTestWidget("com.android.internal.widget.DialogTitle", "Server");
		doTestWidget(16908291, "android.widget.EditText", "");
		doTestWidget(16908313, "android.widget.Button", "Authenticate");
		doTestWidget(16908314, "android.widget.Button", "Cancel");

		// Testing transition 
		// Setting input: i0
		setInput (16908291, "writeText", "90");
		// Firing event: e53
		fireEvent (16908313, 18, "Authenticate", "button", "click");
	...
	public void testTrace00045 () {
		...
		setInput (16908291, "writeText", "90");
		// Firing event: e54
		fireEvent (16908314, 20, "Cancel", "button", "click");
	...
	// Generated from trace 56
	public void testTrace00047 () {
