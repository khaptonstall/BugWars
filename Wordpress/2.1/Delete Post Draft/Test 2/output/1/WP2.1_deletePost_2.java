...
/* Wordpress 2.1 deletePost - Test 2 */
...
public class AndroidGuiTest extends ActivityInstrumentationTestCase2 {
	...
	public void testTrace00001 () {
		...
		// Testing transition 
		// Firing event: e101
		fireEvent (2131165266, 56, "", "linearLayout", "click");
		...
		// Testing transition 
		// Firing event: e115
		fireEvent (2131165393, 7, "", "spinner", "selectSpinnerItem", "6");
		...
		// Testing transition 
		// Firing event: e131
		fireEvent (2131165393, 7, "", "spinner", "selectSpinnerItem", "5");
	...
	public void testTrace00005 () {
		...
		// Testing transition 
		// Firing event: e440
		fireEvent (16908298, 9, "", "listView", "selectListItem", "5");
		...
		// Testing transition 
		// Firing event: e502
		fireEvent (2131165201, 73, "", "button", "click");
		...
		// Testing transition 
		// Firing event: e509
		fireEvent (2131165412, 22, "", "button", "click");
		...
		// Testing transition 
		// Firing event: e533
		fireEvent (2131165201, 33, "", "button", "click");
		...
		// Testing transition 
		// Firing event: e538
		fireEvent (2131165410, 19, "", "button", "click");
