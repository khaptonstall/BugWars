...
/* Wordpress 1.4.0 original
 * Random, 25 steps
 * Meredith WP_140_rand_3
 */
...
public class AndroidGuiTest extends ActivityInstrumentationTestCase2 {
	...
	public void testTrace00000 () {
		...
		solo.assertCurrentActivity("", "wpAndroid");
		...
		solo.assertCurrentActivity("", "tabView");
		...
		// Testing transition 
		// Firing event: e35
		fireEvent (9, "", "listView", "longClickListItem", "1");
		...
		// Testing transition 
		// Firing event: e40
		fireEvent (16908314, 18, "No", "button", "click");
		...
		// Testing transition 
		// Firing event: e170
		fireEvent (16908298, 27, "", "singleChoiceList", "longClickListItem", "2");
		...
		// Testing transition 
		// Firing event: e184
		fireEvent (9, "", "listView", "longClickListItem", "2");
