...
public class AndroidGuiTest extends ActivityInstrumentationTestCase2 {
	...
	// Generated from trace 117
	public void testTrace00000 () {

		// Testing base activity
		retrieveWidgets();
		// Testing current activity: should be a1
		solo.assertCurrentActivity("Testing base activity", "splashScreen");
		...
		// Testing transition 
		// Firing event: e2
		fireEvent (2131099742, 7, "Start a new blog at WordPress.com", "button", "click");
		...
		// Testing transition 
		// Firing event: e16
		fireEvent (2131099744, 9, "Add self-hosted WordPress blog", "button", "click");
		...
		// Testing transition 
		// Setting input: i3
		setInput (2131099655, "writeText", "71");
		// Setting input: i4
		setInput (2131099657, "writeText", "73");
		// Setting input: i5
		setInput (2131099659, "writeText", "75");
		// Firing event: e21
		fireEvent (2131099661, 17, "Save", "button", "click");
		...
		setInput (2131099659, "writeText", "75");
		// Firing event: e33
		fireEvent (2131099662, 18, "Cancel", "button", "click");
		...
		// Testing transition 
		// Firing event: e52
		fireEvent (2131099743, 8, "Add blog hosted at WordPress.com", "button", "click");
	...
	public void testTrace00002 () {
		...
		setInput (2131099659, "writeText", "75");
		// Firing event: e160
		fireEvent (2131099664, 20, "Get a free blog at WordPress.com", "button", "click");
	...
	public void testTrace00011 () {
		...
		setInput (2131099659, "writeText", "75");
		// Firing event: e428
		fireEvent (2131099660, 16, "Optional Settings", "button", "click");

		retrieveWidgets();
		// Testing current activity: should be a85
		solo.assertCurrentActivity("", "addAcountSettings");
		...
		// Testing transition 
		// Setting input: i162
		setInput (2131099666, "writeText", "3");
		// Setting input: i163
		setInput (2131099668, "writeText", "5");
		// Firing event: e441
		fireEvent (2131099662, 13, "Cancel", "button", "click");
