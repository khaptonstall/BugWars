...
/* WordPress 2.0 Kyle's Bug2 - WP20_deleteBlogError_3 */ 
...
public class AndroidGuiTest extends ActivityInstrumentationTestCase2 {
	...
	public void testTrace00002 () {
		...
		// Testing transition 
		// Firing event: e55
		fireEvent (16, "Vibrate", "check", "click");
		...
		// Testing transition 
		// Firing event: e78
		fireEvent (17, "Blink notification light", "check", "click");
		...
		setInput (2131165286, "writeText", "45");
		// Firing event: e176
		fireEvent (2131165280, 25, "", "spinner", "selectSpinnerItem", "3");
		...
		setInput (2131165286, "writeText", "45");
		// Firing event: e208
		fireEvent (2131165285, 31, "", "spinner", "selectSpinnerItem", "7");
		...
		setInput (2131165286, "writeText", "45");
		// Firing event: e275
		fireEvent (2131165285, 31, "", "spinner", "selectSpinnerItem", "8");
	...
	public void testTrace00010 () {
		...
		// Testing transition 
		// Firing event: e643
		fireEvent (2131165201, 59, "", "button", "click");
		...
		// Testing transition 
		// Firing event: e679
		fireEvent (2131165386, 14, "", "button", "click");
		...
		setInput (2131165286, "writeText", "45");
		// Firing event: e725
		fireEvent (2131165287, 34, "Publish", "button", "click");

		// This event leads to crash
		solo.sleep (SLEEP_AFTER_TASK);
	}

	// Generated from trace 974
	public void testTrace00011 () {
		...
		// Testing transition 
		// Firing event: e903
		fireEvent (16908298, 6, "", "listView", "longClickListItem", "6");
