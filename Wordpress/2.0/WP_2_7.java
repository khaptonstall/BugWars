...
public class WP_2_7 extends ActivityInstrumentationTestCase2 {
	...
	public void testTrace00000 () {
		...
		// Testing transition 
		// Firing event: e9
		fireEvent (2131165258, 45, "", "linearLayout", "click");
		...
		// Testing transition 
		// Firing event: e18
		fireEvent (2131165365, 32, "Spam", "button", "click");
		...
		// Testing transition 
		// Firing event: e63
		fireEvent (2131165257, 41, "", "linearLayout", "click");
		...
		// Testing transition 
		// Firing event: e94
		fireEvent (2131165200, 41, "", "button", "click");
		...
		// Testing transition 
		// Firing event: e117
		fireEvent (2131165258, 73, "", "linearLayout", "click");
		...
		// Testing transition 
		// Firing event: e125
		fireEvent (2131165363, 30, "Approve", "button", "click");
