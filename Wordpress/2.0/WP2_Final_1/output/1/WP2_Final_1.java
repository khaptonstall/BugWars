...
/* WordPress 2.0 Final - WP2_Final_1 */
...
public class AndroidGuiTest extends ActivityInstrumentationTestCase2 {
	...
	public void testTrace00008 () {
		...
		// Testing transition 
		// Firing event: e166
		fireEvent (2131165191, 8, "Terms of Service", "button", "click");
	...
	public void testTrace00028 () {
		...
		// Testing transition 
		// Firing event: e338
		fireEvent (2131165296, 14, "More", "button", "click");
		...
		// Testing transition 
		// Firing event: e460
		fireEvent (2131165258, 71, "", "linearLayout", "click");
		...
		// Testing transition 
		// Firing event: e471
		fireEvent (2131165201, 32, "", "button", "click");
		...
		// Testing transition 
		// Firing event: e488
		fireEvent (2131165366, 41, "Reply", "button", "click");

		retrieveWidgets();
		// Testing current activity: should be a59
		solo.assertCurrentActivity("", "ReplyToComment");
		...
		// Testing transition 
		// Setting input: i18
		setInput (2131165331, "writeText", "46");
		// Firing event: e499
		fireEvent (2131165235, 7, "Send Reply", "button", "click");
		...
		// Testing transition 
		// Firing event: e534
		fireEvent (2131165366, 29, "Reply", "button", "click");
		...
		// Testing transition 
		// Firing event: e568
		fireEvent (2131165365, 28, "Spam", "button", "click");
		...
		// Testing transition 
		// Firing event: e634
		fireEvent (2131165252, 65, "", "linearLayout", "click");
	...
	public void testTrace00033 () {
		...
		// Testing transition 
		// Firing event: e669
		fireEvent (16908298, 5, "", "singleChoiceList", "longClickListItem", "1");
	...
	public void testTrace00034 () {
		...
		// Testing transition 
		// Firing event: e783
		fireEvent (19, "Add a tagline to new posts", "check", "click");
		...
		// Testing transition 
		// Firing event: e790
		fireEvent (14, "Play notification sound", "check", "click");
		...
		// Testing transition 
		// Firing event: e799
		fireEvent (2, 9, "My Blog", "check", "click");
