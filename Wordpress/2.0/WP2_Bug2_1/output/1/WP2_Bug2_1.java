...
/* WordPress 2.0 Delete Blog Error - Test 1 */
...
public class AndroidGuiTest extends ActivityInstrumentationTestCase2 {
	...
	public void testTrace00000 () {
		...
		// Testing transition 
		// Firing event: e101
		fireEvent (2131165386, 44, "", "button", "click");
	...
	public void testTrace00003 () {
		...
		// Testing transition 
		// Firing event: e1053
		fireEvent (16908298, 6, "", "listView", "selectListItem", "12");
		...
		// Testing transition 
		// Firing event: e1114
		fireEvent (2131165385, 13, "", "button", "click");
