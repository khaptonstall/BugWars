...
/* WordPress 2.0 Final - WP2_Final_17 */
...
public class AndroidGuiTest extends ActivityInstrumentationTestCase2 {
	...
	public void testTrace00003 () {
		...
		// Testing transition 
		// Firing event: e287
		fireEvent (2131165386, 34, "", "button", "click");
		...
		// Testing transition 
		// Firing event: e342
		fireEvent (2131165201, 36, "", "button", "click");
		...
		// Testing transition 
		// Firing event: e360
		fireEvent (2131165385, 33, "", "button", "click");
		...
		// Testing transition 
		// Firing event: e416
		fireEvent (2131165297, 15, "", "button", "click");
	...
	public void testTrace00007 () {
		...
		// Firing event: e521
		fireEvent (2131165218, 13, "Optional Settings", "button", "click");
		...
		// Testing transition 
		// Firing event: e676
		fireEvent (2131165384, 32, "", "button", "click");
