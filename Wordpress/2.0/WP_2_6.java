...
public class WP_2_6 extends ActivityInstrumentationTestCase2 {
	...
	public void testTrace00000 () {
		...
		// Testing transition 
		// Firing event: e2
		fireEvent (2131165318, 9, "Add self-hosted WordPress blog", "button", "click");
		...
		// Firing event: e26
		fireEvent (2131165218, 15, "Optional Settings", "button", "click");
