...
/* WordPress 2.0 Final - WP2_Final_6 */
...
public class AndroidGuiTest extends ActivityInstrumentationTestCase2 {
	...
	public void testTrace00002 () {
		...
		// Testing transition 
		// Firing event: e1122
		fireEvent (2131165262, 78, "", "linearLayout", "click");
		...
		// Testing transition 
		// Firing event: e1257
		fireEvent (16908298, 6, "", "listView", "selectListItem", "10");
		...
		// Testing transition 
		// Firing event: e1397
		fireEvent (2131165384, 37, "", "button", "click");

		// This event leads to crash
		solo.sleep (SLEEP_AFTER_TASK);
	}

	// Generated from trace 1400
	...
	public void testTrace00004 () {
		...
		// Testing transition 
		// Firing event: e1451
		fireEvent (2131165386, 39, "", "button", "click");
		...
		// Testing transition 
		// Firing event: e1469
		fireEvent (2131165387, 40, "", "button", "click");
		...
		setInput (2131165286, "writeText", "45");
		// Firing event: e1497
		fireEvent (2131165275, 20, "View Map", "button", "click");
